...
|[SandBase Harness](https://github.com/sandbaseai/sandbase-harness)|![GitHub Repo stars](https://badgen.net/github/stars/sandbaseai/sandbase-harness)|本地优先的开源 Agent 运行时，统一管理会话、工具、记忆、凭据、权限和审计，支持本地进程、每会话 Docker 容器、Kubernetes 与自托管 Worker 沙箱，并提供官方 MCP Server。|
